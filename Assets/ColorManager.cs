...
public class ColorManager : Singleton<ColorManager> {
	...
	public static Color BallOneAccelerationColor = new Color32(0x55, 0xC7, 0xDD, 0xFF);
	public static Color BallTwoAccelerationColor = new Color32(0xFF, 0xFF, 0x4C, 0xFF);
	public static Color BallHorizontalVelocityColor = new Color32(0x61, 0xED, 0x00, 0xFF);
	public static Color BallVerticalVelocityColor = new Color32(0xFF, 0xB9, 0x00, 0xFD);
